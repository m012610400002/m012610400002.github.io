...
10|ip_a_config.png|27/05/2026 |Verificar si estan en la misma red.|En windows con ipconfig y en linux con ip a.
11|ping.png|27/05/2026 |Probar conexion.|No olvidar desactivar el firewall en windows para poder tener conectividad.
{%- endcapture -%}
